...
function initializeSession() {
  ...
  var audioDeviceId = localStorage.getItem('com.opentok.hardwaresetup.audio');
  var videoDeviceId = localStorage.getItem('com.opentok.hardwaresetup.video');
  console.log("audio:" + audioDeviceId + " video:" + videoDeviceId);
